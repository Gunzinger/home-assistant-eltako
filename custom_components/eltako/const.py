...
from eltakobus.eep import _EltakoShutterCommand
...
class A5_3F_7F(_EltakoShutterCommand): # this would be better to patch in eltakobus modules eep.py file, right below H5_3F-7F...
